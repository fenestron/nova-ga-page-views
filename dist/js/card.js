...
Nova.booting(function (Vue, router, store) {
  Vue.component('page-views-list', __webpack_require__(2));
});
...
// module
exports.push([module.i, "\n.most-visited-pages-list[data-v-b9bc2c0a] {\n    height: 4.6rem;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        var category = this.card.category;

        Nova.request().get('/nova-vendor/page-views-list?category=' + category).then(function (response) {
    ...
    !_vm.pages
      ...
      : _c(
          ...
          _vm._l(_vm.pages, function(page) {
            return _c("li", { staticStyle: { margin: "2px 0" } }, [
              _c(
                "a",
                {
                  attrs: {
